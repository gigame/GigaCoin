UNIX BUILD NOTES
====================
Some notes on how to build Gigacoin in Unix. 
...
This will build gigacoin-qt as well if the dependencies are met.
...
If you want to build Gigacoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a gigacoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip gigacoind" to strip the debug
