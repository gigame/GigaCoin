...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(kGIG);
    unitlist.append(GIG);
    unitlist.append(Gigtoid);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MGIG: return QString("MGIG");
    case kGIG: return QString("kGIG");
    case GIG: return QString("GIG");
    case Gigtoid: return QString("Gigtoid");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MGIG: return QString("Mega-Gigacoin (1,000,000 GIG)");
    case kGIG: return QString("Kilo-Gigacoin (1000 GIG)");
    case GIG: return QString("Gigacoin");
    case Gigtoid: return QString("Gigtoid (1 / 100,000,000");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MGIG: return Q_INT64_C(100000000000000);
    case kGIG: return Q_INT64_C(100000000000);
    case GIG:  return Q_INT64_C(100000000);
    case Gigtoid: return Q_INT64_C(1);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MGIG: return Q_INT64_C(900000);
    case kGIG: return Q_INT64_C(900000000);
    case GIG:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
    case Gigtoid: return Q_INT64_C(9000000000000000000); // Slightly under max value for int64
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MGIG: return 6;  // 900,000 (# digits, without commas)
    case kGIG: return 9;  // 900,000,000
    case GIG:  return 12; // 900,000,000,000
    case Gigtoid: return 19; // 9,000,000,000,000,000,000
    default: return 0;
    }
}
