...
static const int COINBASE_MATURITY = (60*1); // about 1 hour before blocks mature, so if something goes wrong pools can coordinate before payouts
...
static const uint64_t nMinDiskSpace = 10428800;
...
bool AcceptToMemoryPool(CTxMemPool& pool, CValidationState &state, const CTransaction &tx, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectInsaneFee=true);
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // gigacoin: 1440 blocks found a day. Priority cutoff is 100 gigacoin day / 250 bytes.
    }
 ...
 */
// gigacoin specific implementation, standardizes checks for the hard maturity change at block 145k
