...
static const int64_t MAX_MONEY = 1000000000 * COIN; // Gigacoin: maximum of 1B coins, max transaction 1B
...
public:
    ...
    {
        // Gigacoin: IsDust() detection disabled, allows any valid dust to be relayed.
